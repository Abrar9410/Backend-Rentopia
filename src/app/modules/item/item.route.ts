...
router.get("/rentopia-items", checkAuth(Role.ADMIN), ItemControllers.getRentopiaItems);
...
router.patch("/edit-rentopia-item/:id", checkAuth(Role.ADMIN), multerUpload.array("files"), validateMutationRequest(editItemZodSchema), ItemControllers.editRentopiaItem);
